...
## Final Step!
### Double check that your data make it into ReDU by selecting the "DatasetAccession" button - [link here](https://redu.ucsd.edu/metadataselection) - please check the MassIVE Accession (*i.e.* MassIVE ID) and the Number of Files
